...
final panelRepositoryProvider =
    Provider<PanelRepository>((ref) => const PanelRepository());
...
final sitioFiltroProvider =
    NotifierProvider<SitioFiltro, String?>(SitioFiltro.new);
...
final rangoFiltroProvider =
    NotifierProvider<RangoFiltro, RangoFechas>(RangoFiltro.new);
...
final personalEnSitioProvider =
    FutureProvider<List<PersonalEnSitio>>((ref) async {
...
final visitantesDentroPanelProvider =
    FutureProvider<List<VisitanteDentro>>((ref) async {
  ref.watch(_tickProvider);
  return ref
      .watch(panelRepositoryProvider)
...
final asistenciasPanelProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) {
  return ref.watch(panelRepositoryProvider).asistencias(
...
final turnosPanelProvider = FutureProvider<List<Map<String, dynamic>>>((ref) {
  return ref.watch(panelRepositoryProvider).turnos(
        rango: ref.watch(rangoFiltroProvider),
        sitioId: ref.watch(sitioFiltroProvider),
      );
});
...
final accesosPanelProvider = FutureProvider<List<Map<String, dynamic>>>((ref) {
  return ref.watch(panelRepositoryProvider).registrosAcceso(
        rango: ref.watch(rangoFiltroProvider),
        sitioId: ref.watch(sitioFiltroProvider),
      );
});
...
final bitacoraPanelProvider = FutureProvider<List<Map<String, dynamic>>>((ref) {
  return ref.watch(panelRepositoryProvider).bitacora(
        rango: ref.watch(rangoFiltroProvider),
        sitioId: ref.watch(sitioFiltroProvider),
      );
});
...
final solicitudesPanelProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) {
  return ref
      .watch(panelRepositoryProvider)
